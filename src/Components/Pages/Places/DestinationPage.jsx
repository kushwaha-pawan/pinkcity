  ...
  const attractions = [
    {
      id: 1,
      name: "Amber Fort",
      description: "Magnificent fort with a blend of Hindu and Mughal architecture",
      image: amberfort,
    },
    {
      id: 2,
        ...
        >
          {attractions.map((attraction) => (
            <motion.div
              ...
              variants={itemVariants}
              whileHover="hover"
              className="bg-gradient-to-br from-red-200 to-cyan-200 rounded-xl overflow-hidden shadow-lg transition-shadow duration-300"
              variants={cardHoverVariants} // ✔ only one variants prop
            >
              <motion.div
          ...
          >
            <motion.div className="md:w-1/2">
              ...
              <p className="text-gray-700 mb-4">
                ...
                traditional handicrafts, and delicious cuisine.
              </p>
              <p className="text-gray-700 mb-6">
                From block printing to gemstone jewelry, Jaipur offers a unique shopping experience.
              </p>

              <button
                className="w-[170px] font-bold text-white font-mono animate-shake rounded-full p-2 bg-gradient-to-r from-teal-600 to-rose-600"
              >
                Explore Culture
              </button>
            </motion.div>
            ...
            >
              <div className="grid grid-cols-2 gap-4">
                <motion.div whileHover="hover" variants={imageHoverVariants}>
                  <img src={hawamahal} alt="Hawa Mahal" className="rounded-lg shadow-md h-48 w-full object-cover" />
                </motion.div>

                <motion.div whileHover="hover" variants={imageHoverVariants}>
                  <img src={amberfort} alt="Amber Fort" className="rounded-lg shadow-md h-48 w-full object-cover" />
                </motion.div>

                <motion.div whileHover="hover" variants={imageHoverVariants}>
                  <img src={jalmahal} alt="Jal Mahal" className="rounded-lg shadow-md h-48 w-full object-cover" />
                </motion.div>

                <motion.div whileHover="hover" variants={imageHoverVariants}>
                  <img src={jantarmantar} alt="Jantar Mantar" className="rounded-lg shadow-md h-48 w-full object-cover" />
                </motion.div>
              </div>
            </motion.div>
          </motion.div>
